...
public class ItemSplitLogTFC extends ItemTFC
{
    private static final Map<Tree, ItemSplitLogTFC> MAP = new HashMap<>();

    public static ItemSplitLogTFC get(Tree wood)
    {
        return MAP.get(wood);
    }
    ...
    public ItemSplitLogTFC(Tree wood)
    {
        this.wood = wood;
